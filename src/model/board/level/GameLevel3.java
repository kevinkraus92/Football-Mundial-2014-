...
public class GameLevel3 extends Board {
...
//		refreshEnemies();
	...
	protected void setContents() {
		...
		Opponent opponent1 = new Opponent(new Point(6,4),'a',this);
		Opponent opponent2 = new Opponent(new Point(10,10),'b',this);
