...
public class GameLevel1 extends Board {
	...
	protected Point getPlayerInitPosition(int num) {
		if(num==1){
			playerPosition1=new Point(2,2);
			return playerPosition1;
		}
		else{
			playerPosition2=new Point(9,24);
	...
	protected void setContents() {
		...
		opponents = new LinkedList<Kicker>();
		...
		Opponent opponent3 = new Opponent(new Point(9,17),'a',this);
		Opponent opponent4 = new Opponent(new Point(3,24),'b',this);
		Opponent opponent5 = new Opponent(new Point(12,14),'a',this);
		Opponent opponent6 = new Opponent(new Point(11,16),'b',this);
		Opponent opponent7 = new Opponent(new Point(8,19),'a',this);
		Opponent opponent8 = new Opponent(new Point(7,25),'b',this);
		Opponent opponent9 = new Opponent(new Point(6,7),'a',this);
		Opponent opponent10 = new Opponent(new Point(5,21),'b',this);
		...
		//setContent(Board.HEIGHT-2, 1, cornerLD );
		setFixContent(Board.HEIGHT-2,1,cornerLD);
		//setContent(1, 1, cornerLU );
		setFixContent(1,1,cornerLU);
		//setContent(Board.HEIGHT-2,Board.WIDTH-2, cornerRD );
		setFixContent(Board.HEIGHT-2,Board.WIDTH-2,cornerRD);
		//setContent(1, Board.WIDTH-2, cornerRU );
		...
		setContent(opponent3.getX(), opponent3.getY(), opponent3);
		setContent(opponent4.getX(), opponent4.getY(), opponent4);
		setContent(opponent5.getX(), opponent5.getY(), opponent5);
		setContent(opponent6.getX(), opponent6.getY(), opponent6);
		setContent(opponent7.getX(), opponent7.getY(), opponent7);
		setContent(opponent8.getX(), opponent8.getY(), opponent8);
		setContent(opponent9.getX(), opponent9.getY(), opponent9);
		setContent(opponent10.getX(), opponent10.getY(), opponent10);

		//		setContent(13,22, opponent);
		//		setContent(4,24, opponent);
		//		setContent(10,3, opponent);
		//		setContent(3,6, opponent);
		//		setContent(8,3, opponent);
		//		setContent(9,4, opponent);
		//		setContent(10,17, opponent);
		//		setContent(13,27, opponent);
		//		setContent(17,19, opponent);
		//		setContent(9,10, opponent);
		//		setContent(10,9, opponent);
